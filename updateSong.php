...
<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql = "UPDATE `song` SET `song_name` = '$songname',`artist` = '$artist',`album` = '$album',`year_of_release` = '$year',`duration` = '$duration' WHERE `song`.`song_id` = $song;";
...
<body>
    ...
    <div class="container py-2 my-2">
        ...
        <h2 class="text-center">Update song - <small> <?php
            $songid = $_GET['song'] ;
        ...
        <form action="<?php $_SERVER['REQUEST_URI'] ?>" method="POST">
            ...
            <div class="col-auto my-1 form-group my-4">
                ...
                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="artist">
            ...
            <div class="col-auto my-1 form-group my-4">
                ...
                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="album">
                    <option value="">Choose ...</option>
                    <?php 
            ...
            <div class="form-group my-4">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Year of release" name="year">
            </div>
            <div class="form-group my-4">
                <label for="formGroupExampleInput2">Duration</label>
                <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Duration in seconds" name="duration">
            </div>
            <div class="form-group my-4">
