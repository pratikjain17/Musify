...
<?php  include '_header.php'; ?>
    <div class="container py-2 my-2">
        ...
        <div class="container py-2 my-2">
            <h3 class="text-center">Your Albums</h3> <hr>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Albums</li>
            ...
            <a href="addAlbum.php" class="btn btn-info py-2 my-2" style="float: right;"><i class="fas fa-plus"></i></a>
                ...
                <tbody>
                    <?php 
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <td>'.$album_name.'</td>
                            <td><a href="updateAlbum.php?album='.$album_id.'" class="btn btn-warning"> <i class="fas fa-sync"></i></a>
                            <a href="deleteAlbum.php?album='.$album_id.'" class="btn btn-success"> <i class="fas fa-trash-alt"></i></a></td>
                        </tr>';
                        }
                    ?>
