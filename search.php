            ...
            <table class="table table-striped table-dark py-4 my-4">
                ...
                <tbody>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == "POST") {
                        $songsearch = $_POST['query'];
                        $sql = "SELECT * FROM `music`.`song` WHERE (CONVERT(`song_name` USING utf8) LIKE '%$songsearch%' OR CONVERT(`year_of_release` USING utf8) LIKE '%$songsearch%' OR CONVERT(`duration` USING utf8) LIKE '%$songsearch%' OR CONVERT(`timestamp` USING utf8) LIKE '%$songsearch%')";
